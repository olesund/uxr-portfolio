      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground">Creators avoided our editor because the step-by-step flow couldn't support the editing they wanted</p>
          </div>
          <div>
            <p className="font-semibold text-foreground">2. Video Analysis (Phase 2)</p>
            <p className="text-muted-foreground">Popular videos are complex: multiple clips, synced to music with text overlaid</p>
          </div>
          <div>
            <p className="font-semibold text-foreground">3. Usability Testing (Phase 3)</p>
            <p className="text-muted-foreground">High-quality videos require precise timing across layers—nearly impossible with a step-by-step flow</p>
          </div>
        </div>
        ...
        {/* Flywheel Concept */}
        <div className="space-y-4">
          <p className="font-semibold text-foreground">The Flywheel Effect</p>
          <p className="text-muted-foreground">
