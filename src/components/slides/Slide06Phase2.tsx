    ...
    <SlideContainer slideNumber={5} header="Phase 2: Large-Scale Video Content Analysis">
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          <p className="text-sm font-medium text-muted-foreground">How We Defined "High-Quality"</p>
        ...
        {/* Sample Size */}
        <div className="grid gap-x-8 gap-y-4 text-foreground sm:grid-cols-3">
          <div>
        ...
        {/* Why 2,000 Videos */}
        <div className="space-y-2">
          <p className="font-medium text-foreground">Why 2,000 Videos?</p>
        ...
        {/* Analysis Method */}
        <div className="space-y-4">
          <p className="font-medium text-foreground">How We Analyzed Them</p>
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-muted-foreground">Examples of Attributes Coded</p>
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-muted-foreground">Statistical Analysis</p>
            <ul className="space-y-1 text-muted-foreground">
        ...
        {/* Key Findings */}
        <div className="space-y-4">
          <p className="font-semibold text-foreground">Key Findings: Three Attributes of High-Quality Videos</p>
          <div className="grid gap-6 sm:grid-cols-3">
            <div>
              <p className="font-semibold text-foreground">1. Multiple Clips</p>
              <p className="text-muted-foreground">Videos used more than one clip (vs. single-shot videos)</p>
            </div>
            <div>
              <p className="font-semibold text-foreground">2. Music Synchronization</p>
              <p className="text-muted-foreground">Clips synced to beat/rhythm of music</p>
            </div>
            <div>
              <p className="font-semibold text-foreground">3. Text Synchronization</p>
