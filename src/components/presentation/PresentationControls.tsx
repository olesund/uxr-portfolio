...
const PresentationControls: React.FC<PresentationControlsProps> = ({
  ...
  return (
    <div className="fixed bottom-8 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-full bg-background/95 px-2 py-2 shadow-lg backdrop-blur-sm border border-border">
      <button
        onClick={onPrevious}
