 ...
 *
 * Edit content here — it is used by InstagramReelsCaseStudy.tsx
 */
...
export const readContent = {
    ...
    phases: [
      {
        ...
        type: "Qualitative",
        description: "Talked to and observed Reels creators over the course if six weeks. Discovered they were using third-party apps (like CapCut) instead of Instagram to edit their videos.",
      },
      {
        number: "02",
  ...
  pivot: {
    ...
    constraintNote: "A complete redesign was off the table without stronger evidence. We needed to build the case incrementally — each phase designed to answer one of leadership's specific objections — without requiring a massive upfront resource commitment.",
