 ...
 *
 * Present-mode only, abbreviated for XFN audience.
 * Content: src/data/instagram-reels-anthropic-content.ts
 */
...
const InstagramReelsAnthropic: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const slides = containerRef.current.querySelectorAll('[id^="slide-"]');
  ...
  return (
    <main className="min-h-screen bg-background">
      <div ref={containerRef} className="snap-y snap-mandatory">
        <InstagramReelsAnthropicCaseStudy />
      </div>
...
export default InstagramReelsAnthropic;
